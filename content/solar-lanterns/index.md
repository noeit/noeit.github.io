...
sections:
  - block: markdown
    content:
      ...
      text: |
        ...
        # ☀️ Light for Learning

        *Bringing sustainable solar lighting to students and elderly community members*
  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        - ☀️ **Zero Operating Cost** — Charged by the sun, free to use
        - 🌱 **Environmentally Friendly** — No emissions, no fuel consumption
        - 🛡️ **Safe** — No fire risk from flames or kerosene
  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        **Support This Project** — Help us bring light to more communities. Your contribution funds solar lanterns and distribution to those who need them most.
  ...
  - block: markdown
    content:
      ...
      text: |
        [Internet Access](../internet-access/) · [Digital Literacy Training](../digital-literacy/) · [IT Labs](../it-labs/)
    design:
      columns: '1'
      background:
        color: '#f5f5f5'
